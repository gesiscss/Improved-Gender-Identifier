...
#input_path = '../../../Desktop/Новая папка/GESIS/Gender_Inference/Unpruned_data/Gender_Shade/PPB-2017.zip'
#output_path = '../../../Desktop/Новая папка/GESIS/Gender_Inference/Unpruned_data/Gender_Shade/'
